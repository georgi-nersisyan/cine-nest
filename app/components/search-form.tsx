...
export default function SearchForm({movies, onSearch}:Props) {
   ...
   return (
    <form onSubmit={onFind} className='w-full flex gap-2 sm:w-xs'>
        <input type="text" list='movies-list' className='w-full bg-transparent border-2 border-gray-500 rounded-md p-1' placeholder='Find movie' value={text} onChange={(e) => setText(e.target.value)} />
